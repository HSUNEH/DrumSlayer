...
# python midi_generate.py --data_type practice --midi_number 10 --bpm 120 --beat 1 --sample_rate 48000
######################
...
for b in range(3):
    ...
    for _ in tqdm(range(midi_number)):
        ...
        # write to midi file
        output_dir = f'midi_2_wav/drum_data_{data_type}/generated_midi_numpy/{midi_name}_numpy'
        os.makedirs(output_dir, exist_ok=True)
