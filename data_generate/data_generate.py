...
if __name__ == '__main__':    
    ...
    parser.add_argument('--midi_number', type=int, default=100, help='midi number')
    # parser.add_argument('--beat', type=int, default=1, help='beat')
    parser.add_argument('--loop_seconds', type=int, default=4, help='loop_seconds')
    parser.add_argument('--sample_rate', type=int, default=44100, help='sample_rate')
    parser.add_argument('--grid_random', type=str, default='R', help='R for random, G for grid, RG for random in grid, GG for gaussian in grid')
    parser.add_argument('--mono', type=bool, default=False, help='mono or stereo')
    parser.add_argument('--oneshot_dir', type=str, default='/disk2/st_drums/one_shots/', help='input data directory')
    parser.add_argument('--output_dir', type=str, default='/disk2/st_drums/generated_data/', help='output data directory')
