...
class EncoderDecoderConfig:
    def __init__(self, **kwargs):
        ...
        self.ff_dropout = 0.1
        # Other hparams.
        self.midi_vocab_size = 3+1000+128+3 # <start>,<end>,<pad> 200 velocity bins, 128 pitch bins, 3 drum types. 
        self.audio_rep = "latents"
...
class EncoderDecoder(nn.Module):
    ...
    def forward(self, x, y=None, strategy="greedy", sample_arg=None):
        ...
        # Output
        x_emb = self.audio_projection_layer(x) # [batch_size, seq_len, d_model]
        x_emb_l = self.positional_encoder(x_emb[:,:,0]) # [batch_size, seq_len, d_model]
        x_emb_r = self.positional_encoder(x_emb[:,:,1]) # [batch_size, seq_len, d_model]
