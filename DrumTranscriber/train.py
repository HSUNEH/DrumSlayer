...
def main(args):
    ...
    if WANDB:
        ...
        trainer = pl.Trainer(accelerator="gpu", logger=logger, devices=NUM_DEVICES, max_epochs=1000, precision='16-mixed', callbacks=[n_step_checkpoint], strategy=ddp_strategy,val_check_interval=valid_n_steps)
    else:
