...
class EncoderDecoderConfig:
    def __init__(self, audio_rep, **kwargs):
        ...
        self.ff_dropout = 0.1
        # Other hparams.
        self.midi_vocab_size = 1000+128+4+1 ## <start>,<end>,<pad>,<sep> 1000 time bins, 128 velocity bins, 3 drum types.
...
class EncoderDecoderModule(pl.LightningModule):
    ...
    def step(self, batch):
        ...
        return loss, midi_loss, sum(audio_losses)/18.0
...
class EncoderDecoder(nn.Module):
    def __init__(self, config):
        ...
        self.dac_projection_layer = nn.Linear(config.dec_d_model, config.midi_vocab_size + config.audio_vocab_size * 18)
    ...
    def forward(self, x, y=None, strategy="greedy", sample_arg=None):
        ...
        # y: [batch_size, seq_len, 19]                                      torch.Size([4, 1471, 19])   target_midi_audio_token
        # Output
...
if __name__ == "__main__":
    from encoder_decoder_s import EncoderDecoderModule, EncoderDecoderConfig    
