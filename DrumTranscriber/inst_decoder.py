...
class InstDecoderModule(pl.LightningModule):
    def __init__(self, config):
        ...
        if self.config.train_type == 'kshm':
            ...
            self.audio_loss =   nn.CrossEntropyLoss(reduction = None)
