...
if __name__ == '__main__':
    ...
    dir_ss_kick = './drum_data_practice/proprietary_dataset/kick'
    dir_ss_snare = './drum_data_practice/proprietary_dataset/snare'
    dir_ss_hhclosed = './drum_data_practice/proprietary_dataset/hhclosed'
    dir_ss_hhopen = './drum_data_practice/proprietary_dataset/hhopen'

    dir_midi_kick = './drum_data_practice/generated_midi_numpy/kick'
    dir_midi_snare = './drum_data_practice/generated_midi_numpy/snare'
    dir_midi_hhclosed = './drum_data_practice/generated_midi_numpy/hhclosed'
    ...
    loop_kick = Loop(ss_kick, midi_kick, 5, 100)
    loop_snare = Loop(ss_snare, midi_snare, 5, 100)
    loop_hhclosed = Loop(ss_hhclosed, midi_hhclosed, 5, 100)
